...
if __name__ == "__main__":
    ...
    relevance_scores = evaluate_relevance(input_abstract, identified_abstracts, prompting_client, AZURE_PROMPTING_MODEL_VERSION)
    ...
    comparison_result = compare_related_works(input_related_work, synthetic_related_work, prompting_client, AZURE_PROMPTING_MODEL_VERSION)
